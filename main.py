...
from kivy.graphics.vertex_instructions import Line, platform, Quad, Triangle
...
class MainWidget(RelativeLayout):
    ...
    def reset_game(self):
        ...
        self.pre_fill_tiles_coordicates()
    ...
    def pre_fill_tiles_coordicates(self):
        for i in range(0, 10):
    ...
    def generate_tiles_coordinates(self):
        ...
        for i in range(len(self.tiles_coordinates), self.NB_TILES):
            ...
            if last_x >= end_index - 1:
                r = 2
            print("last_x:  " + str(last_x) + ", start_index: " + str(start_index), ", end_index: " + str(end_index))
    ...
    def update_tiles(self):
        for i in range(0, self.NB_TILES):
            ...
            ti_x = tiles_coordinates[0]
            ti_y = tiles_coordinates[1]
            xmin, ymin = self.get_tile_coordinates(ti_x, ti_y)
            xmax, ymax = self.get_tile_coordinates(ti_x + 1, ti_y + 1)
